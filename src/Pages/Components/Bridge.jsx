...
function Bridge() {
  ...
  <div className="relative group flex-1 max-w-lg">
    {/* Glow */}
    <div className="absolute inset-0 bg-gradient-to-r from-[#CFA80F]/15 to-[#e8c127]/15
    ...
    <div className="relative rounded-xl overflow-hidden shadow-xl
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/30 via-transparent to-transparent
        opacity-50 group-hover:opacity-35 transition-opacity duration-500" />
      ...
      {/* Accents */}
      <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-[#CFA80F]/15 to-transparent" />
      <div className="absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr from-[#CFA80F]/15 to-transparent" />
    </div>
  </div>
</div>
